package com.aliveman.chitchat.Activity;
...
import com.aliveman.chitchat.R;
import com.aliveman.chitchat.ModelClass.Users;
...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database=FirebaseDatabase.getInstance("https://chitchat-1de93-default-rtdb.firebaseio.com/");
        storage=FirebaseStorage.getInstance("gs://chitchat-1de93.appspot.com");
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if(imageUri!=null)
                                {
                                    ...
                                    String staus="Hey There I'm Using This Application";
                                    imageURI="gs://chitchat-1de93.appspot.com/profile.png";
                                    Users users=new Users(auth.getUid(),name,email,imageURI,staus);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
